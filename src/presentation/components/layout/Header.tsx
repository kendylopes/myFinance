import { Cloud, LogOut, Volume2, VolumeX, Wallet } from 'lucide-react'
...
export const Header = ({ transactionCount, user = null, onLogout }: HeaderProps) => {
  ...
  return (
    <header className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/8 pb-6 gap-4">
      ...
      {/* Controles do Cabeçalho: Status de Nuvem, Perfil do Usuário, Som e Contador */}
      <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
        {/* Indicador de Conexão em Nuvem */}
        <div
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border text-xs font-medium backdrop-blur-md bg-emerald-500/10 border-emerald-500/25 text-emerald-300 shadow-[0_0_15px_rgba(16,185,129,0.1)]"
          title={
